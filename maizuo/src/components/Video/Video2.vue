    				...
    				<div class="film-list">
    					<ul class="list">
    							...
    							<li class="li-list" v-for ="(item,index) in list">
    								<router-link :to="{name:'detail2',params:{id:item.id}}">
		    							<div class="film-item">
		    								...
		    								<div class="film-item-inner">
		    									...
		    									<div class="item-inner3">
		    										<span>{{item.premiereAt|formaDate}}</span>
		    									</div>
		    								</div>
		    							</div>
		    						</router-link>
...
<script>
	 ...
	 export default{
	 	...
	 	created(){
	 		var that = this;
	 		this.$http.get('/api/film/coming-soon?__t=1499217323068&page=1&count=20')
